...
import { ArrowRight, Star, Zap, Coffee } from "lucide-react";

const marqueeItems = [
  "前端开发", "UI/UX 设计", "全栈工程", "开源贡献", "创意编程",
  "前端开发", "UI/UX 设计", "全栈工程", "开源贡献", "创意编程",
];
    ...
    <section id="home" className="min-h-screen pt-16 flex flex-col">
      ...
      <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 w-full">
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black leading-none tracking-tighter mt-4">
                ...
                <span className="block text-[#FF6B6B]">远。</span>
              </h1>
            </div>
            ...
            >
              <p className="text-xl font-bold leading-relaxed">
                全栈开发者 & 设计师，专注于构建
                <span className="bg-[#FFD93D] px-1 mx-1">有趣</span>
                且
                <span className="bg-[#C4B5FD] px-1 mx-1">好用</span>
                的数字产品。喜欢把复杂的问题变成优雅的解决方案。
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                查看项目 <ArrowRight className="w-5 h-5 stroke-[3px]" />
              </a>
              <a
                href="#contact"
                onClick={(e) => {
          ...
          {/* Right: Visual Stack */}
          <div className="lg:col-span-2 relative h-96 lg:h-auto lg:min-h-[560px]">
            {/* Background grid */}
            <div
              className="absolute inset-0 border-4 border-black opacity-20 grid-bg"
              style={{ zIndex: 0 }}
            />
            ...
            >
              ...
              <div className="p-6 flex flex-col items-center gap-4">
                <div
                  className="w-28 h-28 border-4 border-black bg-[#C4B5FD] flex items-center justify-center text-5xl font-black"
                  style={{ boxShadow: "6px 6px 0px 0px #000" }}
                >
                  张
                </div>
                <div className="text-center">
                  <p className="font-black text-xl">张明远</p>
                  <p className="font-bold text-sm uppercase tracking-widest text-gray-600">Full-Stack Developer</p>
                </div>
                <div className="flex gap-2 flex-wrap justify-center">
                  {["React", "Next.js", "TypeScript"].map((tag) => (
                    <span
                      key={tag}
                      className="border-2 border-black px-2 py-1 text-xs font-black uppercase tracking-wide"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            >
              <Zap className="w-5 h-5 inline stroke-[3px]" /> 开源
            </div>
            ...
            <div className="absolute bottom-8 left-8 z-20 animate-spin-slow">
              <Star
                className="w-12 h-12 fill-[#FF6B6B] stroke-black stroke-[2px]"
              />
            </div>
          </div>
        </div>
